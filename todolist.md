...
| `wf-vnext-mechanism-families` | 世界基座团队 | 把“参数变化”与“机理变化”分层：支持速率律族、竞争路径/失活路径拓扑和观测因果图干预；机理 hash、适用域、可辨识探针与失败语义可审计 | world-family axes |
...
1. 并行认领 `benchmark-vnext-task-validity`、`wf-vnext-risk-cost-signal`、
   `wf-vnext-mechanism-families`。
