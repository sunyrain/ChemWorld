...
PARENT_PLAN_PATH = ROOT / "configs/methods/rl_v0.4/sac_v0411_preflight_plan.json"
PLAN_PATH = ROOT / "configs/methods/rl_v0.4/sac_v0412_preflight_plan.json"
...
def test_crystallization_domain_retry_is_frozen_namespaced_and_deferred() -> None:
    ...
    assert plan["adapter_reattestation"]["sac_v0411_execution_skipped"] is True
    ...
    assert full_plan["current_contract_preflight"]["required_status"] == (
        "sac_v0412_preflight_passed_full_matrix_allowed"
    )


def test_crystallization_domain_retry_rejects_tampered_parent_source(
