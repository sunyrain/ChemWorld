...
| W2-51 | TERMINAL / SCIENTIFICALLY REJECTED BEFORE PROVIDER | 五条件设计与正式 launcher 已完成：3 tasks × 5 fresh worlds × 3 priors × 5 conditions，计划 225 sessions、45 autonomous donors 和 540 participant experiments。development compact-ID oracle block 曾完成 1,440/1,440 truth/replay 并 15/15 通过。正式 preparation 的首次无内部 liveness 尝试未形成完整 cluster，原样保留且未复用；相同科学设计从第一 cluster 重启。restart 完成前 8 个 formal clusters 的 896/896 provider-free truth 与 exact replay，candidate gates 8/8、oracle gates 7/8；`reaction-to-crystallization / seed836245547` 的 oracle Spearman rho=0.738095，低于冻结 0.80，Top-1 disagreement，fit/candidate overlap=0。按预设 gate，余下 7 clusters、operational canary、225 participant sessions 与 540 participant experiments 均未启动；provider calls=0、formal/result replacement=0。W2-51 不产生五个 participant 因果对比，收口见 `reports/WORK_II_EVIDENCE_TO_ACTION_FORMAL_CLOSEOUT_ZH.md`。 |
