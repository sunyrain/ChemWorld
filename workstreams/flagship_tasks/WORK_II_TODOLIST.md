...
本轮M0/M1开发实验及六张图重构已完成。用户在完成收束后进一步授权全面组织、优化实验和图表。
...
| W2-72 | PLANNED | M1正式复核准备：独立world roster、条件次序平衡、固定主对比/最小实际效应、任务级差异与区间；不以开发样本替代正式分母 |
