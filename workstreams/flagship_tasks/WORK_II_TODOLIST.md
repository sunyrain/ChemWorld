...
| W2-59 | IN PROGRESS / CROSS-MODEL MAIN-EVIDENCE COMPLETION | 用户于 2026-08-31 授权补齐 participant-bearing 主证据的 DeepSeek + `gpt-5.6-sol`/medium 覆盖。冻结块包括 OpenAI public C2 `135` sessions、OpenAI matched A-P+B2 `30` formal sessions、OpenAI W2-50 `45` sessions，以及独立 B3 successor 的 DeepSeek/OpenAI 各 `30` formal sessions；matched/B3 另有合计 `12` 个排除在 formal 分母外的 canary sessions。provider-free W2-51/52/53 不重复，W2-55 在新输出上零 provider 重算。旧结果全部保留，不将 W2-56/57/58 失败拼入新分母。见 `WORK_II_CROSS_MODEL_MAIN_EVIDENCE_COMPLETION_EXPERIMENT_NOTE.md`。 |
