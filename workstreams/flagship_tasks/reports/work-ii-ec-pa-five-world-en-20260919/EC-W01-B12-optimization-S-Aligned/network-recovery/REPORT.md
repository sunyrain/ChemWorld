...
Status: failed; completed batches: 0/12; posttests: 0/3.
...
Original failed attempt is retained separately. Mode: fresh_source_after_partial_network_failure; new source batches: 0. See [recovery accounting](recovery.json).
