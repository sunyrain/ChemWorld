...
| PA-E | False | True | False | False | `[None, None, None, None, None]` | challenge-failed |
...
| C-E | False | True | False | False | `[None, None, None, None, None]` | challenge-failed |
| C-P | True | True | True | True | `[3, 3, 3, 3, 3]` | challenge-passed |

World-probe denominator: `40/50` completed; `25` rows contain a failed probe.

Loci passed: `5/10`; failed: `5/10`.
