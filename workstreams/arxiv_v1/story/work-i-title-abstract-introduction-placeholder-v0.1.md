# Work I title, abstract, and introduction handoff v0.1
...
This is an isolated story handoff. It does not edit the manuscript, bibliography,
figures, derived data, evidence graph, or release artifacts.

## Ranked title candidates

1. **Programmable Chemical Worlds Make Experimental Agency Measurable**
2. **ChemWorld: A Programmable Measurement Apparatus for Experimental Agency**
3. **Measuring Experimental Agency in Programmable Chemical Worlds**

Candidate 1 is recommended. The title-level word *programmable* is supported by the
passed controlled world-fork certificate and the passed known-policy measurement-
validity control. It describes a bounded property of the executable apparatus; it does
not claim arbitrary world recombination, physical-laboratory deployment, rule learning,
or general agent superiority.

Recommended two-line rendering:

```text
Programmable Chemical Worlds Make
Experimental Agency Measurable
```
...
## Integration and replacement ledger

| Region | Disposition | Frozen authority or downstream owner |
| --- | --- | --- |
| Title and two-line title | Replace with candidate 1 | F07 world-fork certificate; V09 validity report; S01/S02 title ceiling |
| Abstract evidence order | Replace in full with the text above | S02 six-beat architecture; final F/V/L and D03/D05 evidence |
| Introduction | Replace in full with the text above | S01 claim map; S02 language/counting locks; S04–S06/S09 handoffs |
| First 120 mention | Preserve the exact 120 = 84 assay + 36 discard partition | S07 language lock; G2 system comparison |
| Latent result | Preserve 6 resolved / 30 unresolved and withhold point estimates | L05/L06 frozen formal result |
| Fresh-session hierarchy | Preserve 2/8 as the endpoint diagnostic and 6/8 as threshold-sensitive support | S02/S07; frozen derived layer |
| Citations | Keys above are inherited from the current bibliography; S08 verifies and owns final related-work citation coverage | W1-S08 |
| Authors and affiliation | Preserve Jiangjie Qiu then Yijun Li and their shared supplied Tsinghua affiliation | W1-D06 partial handoff |
| Correspondence and ORCIDs | Do not invent; remain empty until supplied | W1-D06 external metadata blocker |
| External archive identifier | Do not mention or synthesize | W1-D02, explicitly deferred by project owner |
| Figures, PDF, source bundles, tag/upload | No S03 edits | W1-P09, W1-D07–D09, W1-M06 |

## Handoff boundary

W1-S10 may integrate the three replacement regions verbatim or make copy edits that do
not alter counts, analysis units, evidence direction, censoring, or claim ceilings. It
must not convert the virtual apparatus into physical deployment, the two qualified fork
classes into general recombination, deterministic retest into a second primary sample,
the complete-system description into a backend effect, or the 6/36 latent resolution
into a complete-case estimate.
