...
- **DOING / Claim**：Codex `/root` — **B04** — 补充公开 authoring 示例，覆盖单模块、跨模块、多阶段和受控分叉，并说明 15 个参考任务如何落在统一契约中。
- **TODO**：未见组合、模块参考验证和新增使用案例。
...
| B04 | DOING | 补充公开 authoring 示例 | 至少给出单模块、跨模块、多阶段和受控分叉示例；15 个参考任务可由同一契约体系解释 |
