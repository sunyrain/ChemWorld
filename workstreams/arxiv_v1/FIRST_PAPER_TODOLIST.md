...
- **DOING / Claim**：Codex `/root` — **U00** — 锁定 U01--U06 案例矩阵，明确每项科学问题、组件、agent 可见契约、操作/仪器、资源与过程记录，并让 U05 与 C03 共用未见组合批次。
...
| ID | 状态 | 使用案例 | 论文价值与放置 |
| --- | --- | --- | --- |
| U00 | DOING | 锁定 U01--U06 案例矩阵 | 六个案例的契约、证据角色和共用关系无歧义；U05 与 C03 绑定同一冻结未见组合批次 |
