...
| W1-V07 | P0 | CHANGES_REQUESTED | runner qualification 与 protocol freeze | V03–V06 | 否 |
| W1-V08 | P0 | CLAIMED | 执行 30 campaigns / 180 lifecycles | V07 | 否 |
| W1-V09 | P0 | CLAIMED | 输出 profile recovery、discriminant validity 与 test–retest report | V08 | 是 |
