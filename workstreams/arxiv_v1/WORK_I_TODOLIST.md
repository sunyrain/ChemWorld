...
| ID | P | 状态 | 任务 | 硬依赖 | 可并行 |
| --- | --- | --- | --- | --- | --- |
| W1-F01 | P0 | CLAIMED | 冻结 world component inventory 与 manifest schema | M02 | 是 |
| W1-F02 | P0 | OPEN | 定义 WorldForkSpec、parent/child lineage 和 component diff | M02 | 是 |
| W1-F03 | P0 | OPEN | 定义 public-contract invariance certificate | M02 | 是 |
...
| W1-F10 | P0 | OPEN | 完成 transaction、resource、failure、instrument semantics 总资格表 | F01 | 是 |

### 5.3 Measurement-validity positive controls

| ID | P | 状态 | 任务 | 硬依赖 | 可并行 |
| --- | --- | --- | --- | --- | --- |
| W1-V01 | P0 | OPEN | 冻结 experimental-agency construct 与 profile schema | M02 | 是 |
