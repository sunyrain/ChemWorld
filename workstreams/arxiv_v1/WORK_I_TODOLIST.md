...
| W1-V06 | P0 | DONE | 实现 construct-validity、resource 与 exact-replay audit | V01 draft | 是 |
| W1-V07 | P0 | DONE | runner qualification 与 protocol freeze | V03–V06 | 否 |
| W1-V08 | P0 | DONE | 执行 30 campaigns / 180 lifecycles | V07 | 否 |
| W1-V09 | P0 | DONE | 输出 profile recovery、discriminant validity 与 test–retest report | V08 | 是 |
...
| W1-D04 | P0 | CLAIMED | 为 F/V/L 新增 evidence DAG nodes 与 source binding | reports ready | 是 |
...
| W1-Q02 | P0 | CLAIMED | systems reviewer：security、identity、ledger、replay | implementations | 是 |
| W1-Q03 | P0 | CLAIMED | methods reviewer：construct validity、estimands、censoring | analysis drafts | 是 |
| W1-Q04 | P0 | CLAIMED | chemistry/chemical-engineering reviewer：世界与实验语义 | F/V reports | 是 |
