...
| audit SHA-256 | `5b73e4de82cd9e03ef2af5d13ac07bd41818098825cee37e71c5d6a1225ff735` |
...
3. 新增“发现—保留—恢复”行为指标：首次 incumbent 批次、发现后保留率、回落幅度、恢复时延、诊断/控制改动到下一 final score 的转化效率。
4. 在再次扩大 5×2 前，先对效应相反的 seed 1 和 seed 3 做多条独立 Codex 轨迹，分离世界交互与单次模型随机性。
