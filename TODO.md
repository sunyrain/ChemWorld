...
| Runtime v2 typed downstream operation status | whilesunny | Active | `src/chemworld/runtime/crystallization_services.py`, `src/chemworld/runtime/distillation_services.py`, `src/chemworld/foundation/`, tests/docs | move `crystals_filtered`, `fraction_collected`, and distillation diagnostics out of `WorldState.metadata` into typed equipment/process ledgers | this commit |
