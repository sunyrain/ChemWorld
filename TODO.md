...
| Reaction-network sensitivity split | whilesunny | Active | `src/chemworld/physchem/reaction_network.py`, `src/chemworld/physchem/reaction_sensitivity.py`, tests/docs | move finite-difference sensitivity reports and candidates out of the reaction-network facade without changing public imports | in progress |
