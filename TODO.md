...
| Runtime v2 action catalog world migration | whilesunny | Active | `src/chemworld/world/actions.py`, `src/chemworld/core/actions.py`, env/runtime/world imports, tests/docs | move action constants and vector helpers out of old core so runtime/env/world no longer import `chemworld.core.actions` | this commit |
