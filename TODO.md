...
| Runtime v2 typed crystallization output phases | whilesunny | Active | `src/chemworld/foundation/constitution.py`, `src/chemworld/runtime/crystallization_services.py`, `src/chemworld/world/separation_kernel.py`, tests/docs | move crystallized product and impurity amounts out of metadata into typed solid/mother-liquor phase records | pending |
