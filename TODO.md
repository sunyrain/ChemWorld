...
| Runtime v2 generic ontology cleanup | whilesunny | Active | `src/chemworld/world/ontology.py`, `src/chemworld/world/state_factory.py`, runtime architecture tests/docs | remove fixed A/P/B/D/E as generic world defaults while keeping explicit reference fixtures isolated | this commit |
