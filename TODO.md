...
| Runtime v2 typed final-assay instrument status | whilesunny | Active | `src/chemworld/foundation/state.py`, `src/chemworld/foundation/constitution.py`, `src/chemworld/runtime/instrument_cost_services.py`, tests/docs | move final-assay completion and time out of runtime metadata and into typed instrument equipment status | pending |
