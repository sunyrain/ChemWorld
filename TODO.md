...
| Runtime v2 domain-service registry split | whilesunny | Active | `src/chemworld/runtime/domain_services.py`, `src/chemworld/runtime/domain_service_registry.py`, `src/chemworld/runtime/constitution_factory.py`, tests/docs | move service contracts, registry validation, and constitution factory out of the domain-service composition module | this commit |
