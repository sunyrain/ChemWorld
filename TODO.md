...
| ChemWorldEnv reporting split | whilesunny | Active | `src/chemworld/envs/chemworld_env.py`, `src/chemworld/envs/reports.py`, tests/docs | move task_info, constitution summary, render text, and step info payload construction out of the environment control loop | in progress |
