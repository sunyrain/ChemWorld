...
| Runtime v2 remove core action facade | whilesunny | Active | `src/chemworld/agents/`, `src/chemworld/core/`, notebooks/tutorial helpers, tests/docs | migrate agents and tutorials to `world.actions`, remove the remaining `core.actions` facade, and keep architecture tests blocking reintroduction | this commit |
