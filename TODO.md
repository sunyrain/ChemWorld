...
| Foundation constitution checks split | whilesunny | Active | `src/chemworld/foundation/constitution.py`, `src/chemworld/foundation/constitution_reports.py`, `src/chemworld/foundation/constitution_state_checks.py`, `src/chemworld/foundation/constitution_preconditions.py`, tests/docs | split report contracts, state invariant checks, and operation precondition checks out of the PhysicalConstitution facade | this commit |
