...
| Runtime v2 typed phase material fallback cleanup | whilesunny | Active | `src/chemworld/world/separation_kernel.py`, `src/chemworld/foundation/`, tests/docs | remove phase-record product/impurity metadata fallback; phase material truth must come from typed phase species amounts | claim pushed |
