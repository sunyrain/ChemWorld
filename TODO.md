...
| Runtime v2 role-based spectra cleanup | whilesunny | Active | `src/chemworld/world/spectra.py`, `src/chemworld/world/observation_kernel.py`, tests/docs | remove fixed A/P/B/D/E spectral labels and species-name heuristics from agent-visible raw signals | this commit |
