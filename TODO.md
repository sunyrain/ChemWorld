...
| Runtime v2 remove core objective island | whilesunny | Active | `src/chemworld/core/`, `src/chemworld/world/scoring.py`, tests/docs | remove duplicated `core.objectives`, keep scoring owned by `world.scoring`, and block `chemworld.core` imports in source/tutorials | this commit |
