...
| Runtime v2 typed distillation output phases | whilesunny | Active | `src/chemworld/foundation/constitution.py`, `src/chemworld/runtime/distillation_services.py`, tests/docs | move distillate product and impurity amounts out of metadata into typed distillate/bottoms phase records | pending |
