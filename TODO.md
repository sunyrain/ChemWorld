...
| Runtime v2 final audit and legacy fallback boundary | whilesunny | Active | runtime/env/eval scans, tests/docs/TODO_PROFESSIONAL | enforce removed batch-runtime import boundary, isolate legacy species fallback, and document the mechanism-owned initial-state follow-up | pending |
