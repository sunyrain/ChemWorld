...
| Runtime v2 mechanism compiler split | whilesunny | Active | `src/chemworld/runtime/mechanisms.py`, `src/chemworld/runtime/mechanism_manifest.py`, `src/chemworld/runtime/mechanism_validation.py`, tests/docs | split manifest, validation, hashing, and role-contract helpers out of the mechanism compiler facade without changing compiled mechanism behavior | this commit |
