...
| ChemWorldEnv spaces and observation codec split | whilesunny | Active | `src/chemworld/envs/chemworld_env.py`, `src/chemworld/envs/spaces.py`, tests/docs | move Gym action/observation space definitions and observation array codec out of the environment control loop | in progress |
