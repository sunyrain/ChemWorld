...
| Runtime v2 distillation service split | whilesunny | Active | `src/chemworld/runtime/`, tests/docs | extract shortcut distillation and fraction collection state updates from `domain_services.py` without changing behavior | claim commit |
