...
| DOC-ZH technical architecture UTF-8 repair | whilesunny | Active | `docs/technical_architecture_zh.md`, docs | replace mojibake Chinese architecture report with a current readable summary of Runtime v2, typed ledgers, tasks, datasets, and remaining gaps | in progress |
