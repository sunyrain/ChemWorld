...
| PRO-RUNTIME-A seven-slot reference quarantine | whilesunny | Active | `src/chemworld/world/reaction_kernel.py`, `tests/`, docs | move the fixed A/P/B/D/E ODE out of ordinary runtime semantics, keep it only as an explicit reference fixture, and add boundary tests against runtime imports | pending |
