...
| PhysChem reactors module split | whilesunny | Done | `src/chemworld/physchem/reactors.py`, reactor-family modules, tests, audit docs | next: continue splitting `reaction_network.py` into integration/reference cases, thermochemical coupling, sensitivities, and loaders | this commit |
| Tutorial curriculum hardening and SOTA gap audit | whilesunny | Done | `notebooks/tutorials/`, `docs/`, SOTA references | next: continue splitting `reaction_network.py` into integration/reference cases, thermochemical coupling, sensitivities, and loaders | this commit |
| Tutorial encoding repair and workload expansion | whilesunny | Done | `notebooks/`, tutorial guidance generator, docs/tests | next: continue splitting `reaction_network.py` into integration/reference cases, thermochemical coupling, sensitivities, and loaders | this commit |
| High-level ChemWorld overview document | whilesunny | Done | `docs/`, `mkdocs.yml` | next: continue splitting `reaction_network.py` into integration/reference cases, thermochemical coupling, sensitivities, and loaders | this commit |
