...
| Foundation state ledger split | whilesunny | Active | `src/chemworld/foundation/state.py`, `src/chemworld/foundation/state_ledgers.py`, `src/chemworld/foundation/state_helpers.py`, tests/docs | split typed ledger records and ledger helper functions out of the WorldState facade | this commit |
