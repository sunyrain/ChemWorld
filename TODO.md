...
| Chinese architecture UTF-8 restoration | whilesunny | Active | `docs/technical_architecture_zh.md`, docs | rewrite the Chinese architecture report as a clean UTF-8 document and align it with current Runtime v2 rollback semantics | claim commit |
