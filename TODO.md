...
| Runtime v2 typed phase loss ledger cleanup | whilesunny | Active | `src/chemworld/runtime/phase_ledger_services.py`, `src/chemworld/runtime/crystallization_services.py`, `src/chemworld/runtime/distillation_services.py`, `src/chemworld/world/separation_kernel.py`, tests/docs | remove phase-local `solvent_loss` metadata fallback and read process loss from typed `ProcessLedger.metrics` | this commit |
