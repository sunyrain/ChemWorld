...
| Runtime v2 typed crystallizer seed status | whilesunny | Active | `src/chemworld/foundation/state.py`, `src/chemworld/foundation/constitution.py`, `src/chemworld/runtime/crystallization_services.py`, tests/docs | move crystallization seed status and seed mass out of runtime metadata and into typed crystallizer equipment settings | pending |
