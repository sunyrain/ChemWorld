...
| PRO-RUNTIME-A compiled reaction integrator | whilesunny | Active | `src/chemworld/runtime/mechanisms.py`, `src/chemworld/world/reaction_kernel.py`, `src/chemworld/runtime/reaction_thermal_services.py`, tests/docs | make heat/wait reaction advancement consume compiled stoichiometry and rate laws before deleting the remaining seven-slot lite reaction fallback | pending |
