...
CRYSTALLIZATION_DOMAIN_PLAN_VERSION = "chemworld-ppo-v0412-preflight-plan-0.1"
PREFLIGHT_PROFILES = {
    PLAN_VERSION: {
    ...
    CRYSTALLIZATION_DOMAIN_PLAN_VERSION: {
        "task_id": "benchmark-v05-rl-adapters--slice-ppo-v0412-crystallization-domain-dev",
        "job_version": "chemworld-ppo-v0412-preflight-job-0.1",
        "report_version": "chemworld-ppo-v0412-preflight-report-0.1",
        "attempt_version": "chemworld-ppo-v0412-preflight-attempt-0.1",
        "failure_version": "chemworld-ppo-v0412-preflight-attempt-failure-0.1",
        "execution_status_version": "chemworld-ppo-v0412-preflight-execution-status-0.1",
        "status_prefix": "ppo_v0412",
...
def validate_plan(plan: Mapping[str, Any], protocol: Mapping[str, Any]) -> dict[str, bool]:
    ...
    checks = {
        ...
        or (
            ...
            and reattestation.get("parent_plan_path")
            == "configs/methods/rl_v0.4/ppo_v0411_preflight_plan.json"
    ...
    if schema_version == CRYSTALLIZATION_DOMAIN_PLAN_VERSION:
        ...
        if failed:
            raise PPOPreflightError(
                "PPO crystallization-domain reattestation is invalid: "
                + ", ".join(failed)
            )
