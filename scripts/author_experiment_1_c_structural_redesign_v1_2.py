...
C_REQUIRED_SOURCE_PATHS = {
    ...
    "scripts/run_experiment_1_ec_qualification.py",
    ...
    "src/chemworld/eval/experiment_1_c_qualification.py",
    "src/chemworld/eval/experiment_1_contracts.py",
    "src/chemworld/eval/experiment_1_ec_qualification.py",
