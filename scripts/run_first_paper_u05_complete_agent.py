#!/usr/bin/env python3
"""Run the sole frozen first-paper U05/E02 complete-agent qualification."""
...
from chemworld.eval.first_paper_u05_complete_agent import build_report, write_outputs
...
def main() -> int:
    ...
    if occupied:
        ...
        raise SystemExit(
            "complete-agent qualification output already exists; refusing to overwrite: "
            f"{rendered}"
        )
        ...
        json.dumps(
            {
                ...
                "submitted_action_count": report["summary"][
                    "submitted_action_count"
                ],
                "provider_session_count": report["summary"][
