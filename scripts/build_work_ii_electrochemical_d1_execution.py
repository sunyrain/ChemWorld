#!/usr/bin/env python3
"""Build the provider-ready electrochemical matched-prior D1 config."""
...
DEFAULT_PACKAGE = EVIDENCE_ROOT / "work-ii-electrochemical-matched-prior-package.json"
DEFAULT_PLAN = EVIDENCE_ROOT / "work-ii-electrochemical-matched-prior-qualification.json"
...
def build(
    ...
    *,
    ...
    config["pilot_id"] = "work-ii-electrochemical-matched-prior-d1-execution"
    config["observation_noise_namespace"] = "work-ii-electrochemical-matched-prior-d1-execution"
