...
| PRO-RUNTIME-A mechanism role validation at compile time | whilesunny | Claimed | Cantera mechanism schema validation patterns and ChemWorld mechanism role tests | `src/chemworld/runtime/mechanisms.py`, mechanism tests/docs | validate required target/reactant/initial species and observable role mappings before runtime services receive a compiled mechanism | pending |
