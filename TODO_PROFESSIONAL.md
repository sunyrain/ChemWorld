...
| PRO-RUNTIME-A compiled mechanism required across runtime services | whilesunny | Claimed | Cantera mechanism-driven runtime architecture and ChemWorld role mapping tests | `src/chemworld/runtime/`, tests/docs | remove optional compiled-mechanism constructors and generic legacy species defaults from ordinary runtime role resolution | pending |
