...
| PRO-RUNTIME-A seven-slot reference quarantine | whilesunny | Claimed | Cantera mechanism-driven runtime architecture and ChemWorld golden runtime tests | `src/chemworld/world/reaction_kernel.py`, `tests/`, docs | quarantine the fixed A/P/B/D/E ODE as an explicit reference fixture and prevent runtime/domain services from importing it | pending |
