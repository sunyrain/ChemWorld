...
The [English PDF](../../../output/pdf/archive/ncs/chemworld-ncs-en-preserved.pdf) uses exports made after reopening the finalized PPTX. The article's prose, captions, Methods and supplementary evidence are unchanged by this correction.
...
uv run --no-sync python paper/tools/build_venue_manuscripts.py --venue ncs --output output/pdf/archive/ncs/chemworld-ncs-en-preserved.pdf
```
