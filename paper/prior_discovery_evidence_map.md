...
| DeepSeek operational burden is concentrated outside provider transport | Development harness accounting | Five-task completion denominators and retained terminal tool receipts | Complete, non-formal | Report 73 validation failures, 69 recovered MCP failures, 3 resource rejections and 0 provider errors as separate operational denominators; do not infer bare-model reliability |
