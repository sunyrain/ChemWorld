...
# 6. F1--F3: search, structure and executable knowledge
...
## 6.3 F1: Predictive learning does not establish selective repair
...
## 6.4 F2: Numerical prediction and structural identification
...
\begin{figure*}[tp]
\centering
\includegraphics[width=\textwidth]{figures/prior-discovery/figure-9-final-diagnostic.pdf}
...
# 7. F4: submitted laws, unseen actions and success conditions
...
The four conversion questions retain distinct denominators: F1 tests selective correction, F2
joint structure recovery, F3 executable fidelity, and F4 previously unseen choices. The final F2
diagnostic separates 17 aligned-prior retentions from zero opaque/misspecified recoveries;
improved paired numerical predictions do not establish structural recovery on this surface.
...
failure to identify an identifiable law. The historical multi-pair control used a privileged reference fitter, with sparse recovery and
13 DeepSeek schema failures. The final minimal-interface block retained 117/120 valid sessions
but zero joint recoveries in 80 opaque or misspecified cases. Its tool-effect interval crosses
zero, and GPT never used the offered tool. Neither public-only identifiability nor recovery of
arbitrary causal graphs follows from these results.
...
accepted after 888 rejected typed submissions. The final diagnostic measures optional numerics under a minimal submission, but its historical
comparison does not randomly isolate reduced schema burden.
...
## 10.11 Minimal-interface and optional-numerics diagnostic
