...
# Results: controlled artifact and information interventions
...
Historical controls retain additional limits. B2 is underidentifying; B3 retains 13 DeepSeek
schema failures. Low reasoning is not thinking-off. Donor-eligible analyses are sensitivity-only,
