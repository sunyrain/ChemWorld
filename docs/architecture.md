...
- **Core**：当前 v0.4 正式确认比较的四任务范围——`partition-discovery`、
  `reaction-to-crystallization`、`reaction-to-distillation`、`flow-reaction-optimization`；
...
专家建议中的平衡、结晶、电化学和流动是有用的**物理原型**，但不会追溯性替换已冻结的 v0.4 Core。
若未来改变正式 Core，必须发布新的 major protocol。
