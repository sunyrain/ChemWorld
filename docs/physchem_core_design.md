...
heat-balance coupling。World Law v0.4 继续在 Gym crystallization task 中执行该 provider，并
...
World Law v0.4 的 flow runtime 使用共享 compiled mechanism 的几何解析 PFR：由流量与停留时间
