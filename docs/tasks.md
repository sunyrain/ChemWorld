...
!!! info "15 任务设计矩阵"
    ...
    已汇总到本轮机器可读设计矩阵。两个确认性任务已完成正式 S0；其余 13 个任务完成设计合同，
    本轮不要求昂贵模型实验。
...
15 个中点配方均已端到端执行，死坐标和未解决正式化 blocker 均为 0。该检查是设计 smoke，不能替代
其余 13 个任务尚未进行的正式模型实验。
...
| --- | --- | --- | --- |
| `electrochemical-conversion` | `d21bed11c4c0e4c9d0bf95ebc8dcc07dc355774e3095c93c27b775b036a71e96` | `reference_validated` | `false` |
