...
连续调节设备设定。适合 SAC、MPC、system identification 与 world-model control。
...
隐藏机理与构成律变化已通过可辨识性、守恒和回放控制；Agent 的识别与迁移仍是开放实验。
...
ChemWorld Core 使用受控、可干预的虚拟规律，不承诺匿名催化剂或虚拟最优条件对应某个现实体系。
...
<p class="cw-status-footer">Research status: benchmark candidate · World Law v0.4 · Evidence snapshot: 2026-07-12 · <a href="benchmark_release/">查看证据</a> · <a href="limitations/">查看边界</a></p>
