...
The separate v1.1 correct-anonymous-material-information extension has completed
the first five paired worlds per task; both point estimates are positive, but
both intervals cross zero, so it remains an interim descriptive result. On the frozen RC28 source, the
