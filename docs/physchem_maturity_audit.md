...
| Phase equilibrium | Lite with reference-validated Wilson/NRTL gamma and mixture VLE diagnostic slices | ideal VLE, Wilson/NRTL gamma checks against `thermo`, curated bubble/dew temperature reports, Rachford-Rice diagnostic closure tests, LLE split tests | UNIQUAC, phase stability, gamma-phi/EOS flash, azeotrope detection, and nonideal VLE/LLE task cases |
