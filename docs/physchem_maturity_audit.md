...
| Phase equilibrium | Lite with reference-validated Wilson/NRTL gamma, mixture VLE, and gamma-phi diagnostic slices | ideal VLE, Wilson/NRTL gamma checks against `thermo`, curated bubble/dew temperature reports, gamma-phi K-value reports, binary relative-volatility crossing diagnostics, Rachford-Rice diagnostic closure tests, LLE split tests | UNIQUAC, phase stability, rigorous gamma-phi/EOS flash, azeotrope curve tracing, and nonideal VLE/LLE task cases |
