...
- 继续把 crystallization、continuous-flow、electrochemistry 的过程 proxy 拆成更独立的 world kernel；distillation 已有 VLE shortcut 和 Fenske-Underwood-Gilliland sizing，下一步推进到 MESH-lite、boilup、压力降积分和水力学约束；
