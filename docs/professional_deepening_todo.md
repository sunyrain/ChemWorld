...
| `DEEP-D5C` | whilesunny | Claimed | Mechanism schema and manifest slice: schema-versioned mechanism contracts, validation report, deterministic hash manifest, and replay/submission audit hooks. |
