...
| `DEEP-R1C` | whilesunny | Claimed | Task runtime service contract: profile-declared required domain services, service/capability coverage validation at runtime startup, and serialized task-info service requirements. |
