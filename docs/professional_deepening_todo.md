...
| `DEEP-D3B` | whilesunny | Claimed | Pure-fluid saturation solver: saturation pressure/temperature solve, critical-region warnings, validity-bound checks, residual diagnostics, reference-backend comparison hooks, tests, docs, and public API exports. |
