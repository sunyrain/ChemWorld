...
| `DEEP-D9B` | whilesunny | Claimed | IR functional-group spectrum slice with curated local band catalog, formula/role-based assignments, broadening, overlap warnings, calibration examples, tests, model card, and public signal API integration. |
