...
| `DEEP-D3C` | whilesunny | Claimed | Mixture bubble/dew flash slice: bubble/dew temperature reports, K-value initialization from pure saturation reports, Rachford-Rice diagnostics, nonconvergence guards, tests, docs, and public API exports. |
