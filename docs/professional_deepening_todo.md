...
| `DEEP-D3D` | whilesunny | Claimed | Gamma-phi VLE bridge slice: gamma/phi/Psat/K-value reports, vapor fugacity coefficient contract, binary azeotrope residual scan, crossing diagnostics, tests, docs, model card, and public API exports. |
