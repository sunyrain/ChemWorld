...
REQUIRED_IMPLEMENTATION_ARTIFACTS = (
    "configs/benchmark/mechanism_adaptation_gate_a_v0.2.7.json",
...
def build_mechanism_adaptation_preflight(
    ...
    gate_a_plan_path = configuration_root() / "benchmark/mechanism_adaptation_gate_a_v0.2.7.json"
    ...
    artifacts = []
    required_artifacts = (*REQUIRED_IMPLEMENTATION_ARTIFACTS, design_audit_relative)
    ...
    gate_status = (
        evaluate_protocol_gates(protocol, {}, gate_a_plan=gate_a_plan)
