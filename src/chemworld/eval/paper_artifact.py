...
def create_paper_artifact(
    *,
    ...
    (root / "README.md").write_text(
        ...
        "dataset cards, replay manifests, release checklist files, and reproduction "
        "commands for a local preprint artifact.\n",
        encoding="utf-8",
    )
    ...
    *,
    ...
    items = [
        ...
        },
        {
            ...
            "status": "required",
            "evidence": "docs/pre-release limitations statement",
        },
    ]
    return {
