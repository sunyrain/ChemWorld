"""Operation-kernel registry and default service-backed kernel."""
...
class ServiceOperationKernel:
    ...
    def plan(
        ...
        return KernelPlan(
            ...
            affected_ledgers=affected_ledgers(self.operation_type),
    ...
    def apply(
        ...
        affected = affected_ledgers(self.operation_type)
